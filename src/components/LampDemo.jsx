...
export const LampContainer = ({ children, className }) => {
  return (
    <div
      className={cn(
        "relative z-0 flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950",
        className,
      )}
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-logo blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[80rem] -translate-y-[7rem] bg-cyan-300"
        ></motion.div>
